...
const LandingPage = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-gray-900 to-purple-900 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          {/* Logo/Title */}
          <h1 className="text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-200 to-purple-400">
            Zen Garden
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="p-6 rounded-lg bg-purple-900/20 backdrop-blur-sm border border-purple-800/30">
              <div className="text-3xl mb-4">🌱</div>
              <h3 className="text-lg font-semibold mb-2">Track Habits</h3>
              <p className="text-purple-200">Monitor your daily practices with ease</p>
            </div>
            <div className="p-6 rounded-lg bg-purple-900/20 backdrop-blur-sm border border-purple-800/30">
              <div className="text-3xl mb-4">📊</div>
              <h3 className="text-lg font-semibold mb-2">Visualize Progress</h3>
              <p className="text-purple-200">See your growth through beautiful charts</p>
            </div>
            <div className="p-6 rounded-lg bg-purple-900/20 backdrop-blur-sm border border-purple-800/30">
              <div className="text-3xl mb-4">🎯</div>
              <h3 className="text-lg font-semibold mb-2">Set Goals</h3>
              <p className="text-purple-200">Define and achieve your objectives</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              to="/login" 
              className="px-8 py-3 rounded-lg bg-purple-900/40 text-purple-100 font-medium border border-purple-700 hover:bg-purple-900/60 transition-colors"
            >
              Sign In
            </Link>
          </div>
